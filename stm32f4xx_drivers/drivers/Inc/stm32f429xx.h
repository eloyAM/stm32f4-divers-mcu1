...
#define UART7_BASEADDR		(APB1PERIPH_BASE + 0x7C00U)
#define UART8_BASEADDR		(APB1PERIPH_BASE + 0x7800U)
...
#define USART7_REG_RESET()	do{ (RCC->APB1RSTR |= (1 << 30)); (RCC->APB1RSTR &= ~(1 << 30)); }while(0)
#define USART8_REG_RESET()	do{ (RCC->APB1RSTR |= (1 << 31)); (RCC->APB1RSTR &= ~(1 << 31)); }while(0)
